...
export namespace VideoStream {
    ...
    /**
     * Returns the last frame captured from the Raspberry Pi Camera as a nodejs buffer.
     * Null if camera has not recorded any frames.
     */
    function getLastFrame(): Buffer | null;
}
